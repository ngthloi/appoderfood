...
import com.example.appfood.activity.Admin.MainAdminActivity;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Url.checkSigIn, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    if(response.equals("Success")){
                        ...
                        startActivity(new Intent(DangNhapActivity.this, (user_phone.equals("0999999999"))?MainAdminActivity.class: MainActivity.class));
